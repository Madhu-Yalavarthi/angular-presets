...
@Component({
  selector: 'app-canvas-circular-proggress',
  templateUrl: './canvas-circular-proggress.component.html',
  styleUrls: ['./canvas-circular-proggress.component.scss']
})
export class CanvasCircularProggressComponent implements OnInit, AfterViewInit, OnChanges {
